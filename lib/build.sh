...
download_node() {
  ...
  if [ ! -f ${cached_node} ]; then
    ...
    echo "Downloading and installing node 18.12.0..."
    local url="https://heroku-nodebin.s3.us-east-1.amazonaws.com/node/release/linux-x64/node-v18.12.0-linux-x64.tar.gz"
